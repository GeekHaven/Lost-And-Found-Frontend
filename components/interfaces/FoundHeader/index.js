...
export default function FoundHeader({ setQuery }) {
  ...
  return (
    <>
      <div
        className="flex flex-col gap-y-16 pt-16 pb-32 sm:py-8 items-center justify-center bg-[#FFFFFF]"
      ...
      >
        ...
        <div className="flex flex-row gap-14 flex-wrap -mt-24 scale-75 sm:scale-50  sm:justify-center">
          <form className="flex flex-row  sm:w-full" onSubmit={handleSubmit}>
            <div className="rounded-l-xl text-[#ffffff] w-[40vw] sm:w-full ">
              <input
                ...
                autoComplete="off"
                className=" rounded-l-xl h-full w-full  bg-[#304AC1] text-xl text-[#ffffff] placeholder:text-[#ffffff] placeholder:font-normal placeholder:text-2xl p-6 sm:py-9"
              />
            </div>
            <button
              ...
              type="submit"
            >
              <Image src={search} width={65} height={65} className="scale-50" />
            </button>
          </form>
          <Link href="/add/found">
