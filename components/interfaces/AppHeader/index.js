...
export default function AppHeader() {
  return (
    <>
      ...
      >
        <h1 className="font-[500] -mb-2 text-5xl font-['Open Sans'] md:text-5xl sm:px-32 sm:text-4xl sm:text-center sm:leading-tight text-[#091553] text-center leading-12 ">
