...
export default function Footer() {
	return (
		<>
			<div
				className="w-full flex bg-[#000000] text-[#ffffff] pt-10 pb-6 justify-around"
			...
			>
				...
				<div className="flex flex-col">
					<h5
						className="text-xl mb-1.5 font-bold tracking-normal"
			...
			<div
				className="w-full flex bg-[#000000] text-[#ffffff] justify-center font-light tracking-normal"
