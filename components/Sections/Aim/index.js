                ...
                <div className="w-[50%] ml-24 mt-4">
                    <ul className="px-4" style={{ listStyleType: "disc" }}>
                        <li className="text-lg font-normal text-[#6d7392]">
                            Lost something? Found something? you can post the
                            details of the lost/found items with ease
                        </li>
                        <li className="text-lg font-normal mt-8 text-[#6d7392]">
                            No need to spam emails that nobody reads everafter!
                        </li>
                        <li className="text-lg font-normal mt-8 text-[#6d7392]">
                            Normalised because Lost and Found is made for the
                            sole purpose of finding the lost items.
                        </li>
                        <li className="text-lg font-normal mt-8 text-[#6d7392]">
                            If bulk quantity of items are lost, Lost&Found helps
                            you find your lost items faster than you can
                            imagine!
                        </li>
                        <li className="text-lg font-normal mt-8 text-[#6d7392]">
                            Easy to connect with users that have Found/Lost
                            something.
                        </li>
                    </ul>
                </div>
