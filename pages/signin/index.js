...
export default function SignIn() {
  ...
  return (
    <div className="h-screen flex bg-[#fafafa]">
      <SEO title="SignIn / Lost&Found" desc="SignIn to Lost And Found IIITA " />
      <form
        className="flex flex-col w-screen justify-center items-center self-center my-auto"
        onSubmit={handleLogin}
      >
        <div className="flex flex-col items-center justify-center rounded-2xl bg-[#ffffff] p-12 shadow-[0_4px_16px_0_rgba(0,0,0,0.15)]">
          <h1 className="font-base text-5xl mb-10 text-[#304AC1] font-[`Open Sans`]">
            Sign In
          </h1>
          <div
          ...
          <div
            className="text-sm box-border h-11 w-96 border-2 border-solid border-slate-400 rounded-md mb-8 flex align-middle bg-[#EBEFFA]"
            ref={passwordDiv}
          >
            <IoMdLock
