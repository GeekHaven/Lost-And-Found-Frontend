          ...
          <div className="flex flex-col gap-y-10 px-[10%] my-auto flex-grow">
            ...
            >
              <li className="text-lg font-normal mb-6">
                If you've found an item, you can post it here.
              </li>
              <li className="text-lg font-normal mb-6">
                Describe the item you have found in as much detailas possible,
                especially any unique characteristics that can help in
                identification.
              </li>
              <li className="text-lg font-normal mb-6">
                Include the location where you have found the item for better
                chances of finding the owner.
              </li>
              <li className="text-lg font-normal mb-6">
                If possible, also mention the date,time or event during which
                you found the item. You can leave the item with the security
                guard and mention in the description.
              </li>
              <li className="text-lg font-normal mb-6">
