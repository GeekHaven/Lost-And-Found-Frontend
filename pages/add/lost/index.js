                    ...
                    <div className="flex flex-col gap-y-10 px-[10%] my-auto flex-grow">
                        ...
                        >
                            <li className="text-lg font-normal mb-6">
                                If you've lost an item, first go through the
                                found list carefully before listing new item.
                            </li>
                            <li className="text-lg font-normal mb-6">
                                Describe the item you have lost in as much
                                detail as possible, especially any unique
                                characteristics that can help in identification.
                            </li>
                            <li className="text-lg font-normal mb-6">
                                Include the location where you have lost your
                                item for better chances of finding the item.
                            </li>
                            <li className="text-lg font-normal mb-6">
                                If possible, also mention the date, time or
                                event during which you have lost the item.
                            </li>
                            <li className="text-lg font-normal mb-6">
                                False information and spamming may result in
                                strict action and a permanent ban from the
                                website.
                            </li>
                        </ul>
                    </div>
